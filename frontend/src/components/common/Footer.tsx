    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <Link to="/">
            <img src={logo} alt="WorldInsights" className="h-7 w-auto" />
          </Link>
          <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
            A platform for curious minds. Explore ideas across technology, design, business, and beyond.
          </p>
          <div className="flex gap-3">
            ...
            {/* GitHub */}
            <a href="#" aria-label="GitHub" className="text-gray-400 hover:text-gray-700 transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Explore */}
        <div>
          <h3 className="text-sm font-semibold text-gray-900 mb-4 tracking-wide uppercase">Explore</h3>
        ...
        {/* Account */}
        <div>
          <h3 className="text-sm font-semibold text-gray-900 mb-4 tracking-wide uppercase">Account</h3>
          <ul className="space-y-2.5">
            {[
              ...
              { to: '/posts/new', label: 'Write a post' },
            ].map(({ to, label }) => (
              <li key={label}>
                <Link to={to} className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  {label}
      ...
      <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400">
        <p>© {new Date().getFullYear()} WorldInsights. All rights reserved.</p>
